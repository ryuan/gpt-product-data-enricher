...
def main():
    ...
    for process_order_number in process_order_numbers:
        ...
        modules.generate_batch_payloads(process_order_number, dependency_results, batch_manager, sku_col_name, sku_to_model, model_to_skus, 
        ...
        if process_order_number == 1:
            dependency_results = modules.get_dependency_results(fields_df, batch_manager)
